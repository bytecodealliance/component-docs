...
continue to evolve and new ones will be introduced; however, users of the component model can now pin to any stable release >= `v0.2.0`. See [WASI.dev](www.wasi.dev) to stay up to date on the latest releases.
