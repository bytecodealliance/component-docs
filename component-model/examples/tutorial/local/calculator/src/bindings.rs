    ...
    pub mod adder {
        ...
        pub mod add {
            ...
            pub fn add(a: u32, b: u32) -> u32 {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "component-book:adder/add@0.1.0")]
                    extern "C" {
                        #[link_name = "add"]
...
pub mod exports {
    ...
    pub mod component_book {
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          #[export_name = "component-book:calculator/calculate@0.1.0#eval-expression"]
...
ook:adder/add@0.1.0\x05\0\x01B\x04\x01m\x01\x03add\x04\0\x02op\x03\0\0\x01@\x03\x02\
op\x01\x01xy\x01yy\0y\x04\0\x0feval-expression\x01\x02\x04\x01)component-book:ca\
lculator/calculate@0.1.0\x05\x01\x04\x01*component-book:calculator/calculator@0.\
